...
<div class="container formulario">
    <div class="row">
      <div class="col-md-4"></div>
         <div class="col-md-6">
           <br>
           <h2>Registro de persona representantes</h2>
         </div>
     </div>
 
<form action="<?php echo RUTA_URL; ?>/Estudiantes/registrar_representante_nuevo" method="POST">
     
    <div class="row">
      <div class="col-md-2">
        <input class="form-group" type="text" name="ci" id="ci" placeholder="Cedula de identidad">
        <input class="form-group" type="text" name="pnombre" id="pnombre" placeholder="Primer nombre">
        <input class="form-group" type="text" name="segnombre" id="segnombre" placeholder="Segundo nombre">
        <input class="form-group" type="text" name="papellido" id="papellido" placeholder="Primer apellido">
        <input class="form-group" type="text" name="segapellido" id="segapellido" placeholder="Segundo apellido">
        <input class="form-group" type="text" name="nacionalidad" id="nacionalidad" placeholder="Nacionalidad">
        <input class="form-group" type="text" name="sexo_p" id="sexo_p" placeholder="Sexo">
      </div>
      <div class="col-md-2"> 
