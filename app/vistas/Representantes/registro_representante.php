  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-3 offset-3 mt-5">
        <input readonly class="form-control" type="text" value="<?php echo($datos['pnombre']) ?>" name="pnombre" id="pnombre">
      </div> 
      
      <div class="col-3 mt-5">
        <input readonly class="form-control" type="text" value="<?php echo($datos['papellido']) ?>" name="papellido" id="papellido">
      </div>
    ...
    <div class="row">
      ...
      <div class="col-6 offset-3">
        <input readonly class="form-control" type="text" value="<?php echo($datos['ci_representante']) ?>" name="ci_representante" id="ci_representante">
      </div>
    </div>
