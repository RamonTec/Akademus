	...
	<script type="text/javascript" src="<?php echo RUTA_URL; ?>/js/fonts.js"></script>
	<script src="<?php echo RUTA_URL; ?>/chartjs/jquery-1.12.0.min.js"></script>
	<script src="<?php echo RUTA_URL; ?>/chartjs/dist/Chart.bundle.js"></script>
</body>
</html>